...
class AdmissionStatusController extends Controller
{
   ...
   public function statusList($id)
   {
    ...
    public function index()
    {
        ...
        return $this->apiResponseResourceCollection(200, 'Non Applied Job list', AdmissionResource::collection($admissions));
    }
    ...
    public function status($admission)
    {
        $status  = [
            [
                ...
                'long'  => null,
                'file' => null,
                'active' => ExcelUpload::where([['admission_id', $admission->id], ['type', 1]])->first() !=  null ? 1 : null,
                'type'   => 1
            ],
            [
                'id' => 2,
                ...
                'long'  => null,
                'file' => null,
                'active' => ExcelUpload::where([['admission_id', $admission->id], ['type', 2]])->first() !=  null ? 1 : null,
                'type'   => 2
            ],
            [
                'id' => 3,
                ...
                'long'  => null,
                'file' => null,
                'active' => ExcelUpload::where([['admission_id', $admission->id], ['type', 3]])->first() !=  null ? 1 : null,
                'type'   => 3
            ],
            [
                'id' => 4,
                ...
                'long'  => null,
                'file' => null,
                'active' => ExcelUpload::where([['admission_id', $admission->id], ['type', 4]])->first() !=  null ? 1 : null,
                'type'   => 4
            ],
            [
                'id' => 5,
                ...
                'long'  => null,
                'file' => null,
                'active' => ExcelUpload::where([['admission_id', $admission->id], ['type', 5]])->first() !=  null ? 1 : null,
                'type'   => 5
            ],
            [
                'id' => 6,
                ...
                'long'  => null,
                'file' => null,
                'active' => ExcelUpload::where([['admission_id', $admission->id], ['type', 6]])->first() !=  null ? 1 : null,
                'type'   => 6
            ],
        ];
        return $status;
