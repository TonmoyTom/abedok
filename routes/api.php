...
Route::middleware('apiRules')->group(function () {
    ...
    // All APi Resource
        ...
        Route::post('applied-job-store-merchant/{id}', [PaymentController::class, '21'])->name('applied-job-payment.store');

        //React  Admission
        Route::post('user-admission-web-store', [UserAdmissionController::class, 'userAdmissionStore'])->name('user-web-admission.store');
        ...
        Route::get('pdf' , [\App\Http\Controllers\PdfController::class , 'store']);

        Route::get('ref' , [\App\Http\Controllers\PdfController::class , 'store']);
